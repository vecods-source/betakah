...
const eventImages = {
  ...
  funeral: [
    require('../../assets/funeral/freepik__fancy-clear-minimal-arab-funeral-ceremonial-incens__20565.png'),
    require('../../assets/funeral/freepik__fancy-clear-minimal-arab-funeral-ceremonial-incens__20566.png'),
    require('../../assets/funeral/funeral.jpg'),
  ],
  business: [
...
export const mockInvitedEventsAR: Event[] = [
  ...
  },
  {
    id: 'event-19',
    type: 'CONDOLENCE',
    title: 'تعزية عائلة الهاجري',
    description: 'ببالغ الحزن والأسى ننعي وفاة المرحوم عبدالله الهاجري، تقبل العزاء في المجلس',
    coverImage: eventImages.funeral[2],
    status: 'PUBLISHED',
    startDate: addDays(1),
    location: 'مجلس الهاجري، الريان',
    guestCount: 150,
    hostId: 'user-6',
    host: mockUsersAR[4],
    userRole: 'GUEST',
  ...
  },
  {
    id: 'event-20',
    type: 'CONDOLENCE',
    title: 'تعزية عائلة السويدي',
    description: 'إنا لله وإنا إليه راجعون، ننعي وفاة الحاجة فاطمة السويدي رحمها الله',
    coverImage: eventImages.funeral[1],
    status: 'PUBLISHED',
    startDate: addDays(3),
    location: 'مجلس السويدي، الوكرة',
    guestCount: 120,
    hostId: 'user-5',
    host: mockUsersAR[3],
    userRole: 'GUEST',
...
export const mockNotificationsAR: Notification[] = [
  ...
  },
  {
    ...
    type: 'INVITATION_RECEIVED',
    title: 'دعوة تعزية',
    body: 'عبدالله الهاجري دعاك لحضور تعزية عائلة الهاجري',
    eventId: 'event-19',
    invitationId: 'invitation-ar-8',
    isRead: false,
    createdAt: subtractDays(0),
  },
  {
    ...
    type: 'INVITATION_RECEIVED',
    title: 'دعوة تعزية',
    body: 'سارة السويدي دعتك لحضور تعزية عائلة السويدي',
    eventId: 'event-20',
    invitationId: 'invitation-ar-9',
    isRead: false,
    createdAt: subtractDays(1),
  },
];
